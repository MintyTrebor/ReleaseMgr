                ...
                return { 
                    plugin: {
                        ReleaseMgr: {
                            ...
                            noticeDark: '<strong>ReleaseMgr</strong> is your wingman in the firmware updating process.<br><br><strong>ReleaseMgr</strong> attempts to identify information in the Duet release notes that may impact your current configuration, by matching information in your <strong>config.g</strong> and hardware setup:<br><br><span class="red lighten-3 black--text">Red highlighting indicates G-codes matched in your config.g</span><br><span class="blue lighten-4 black--text">Blue highlighting indicates hardware matched in your setup</span><br><span class="purple darken-4">Purple highlighting indicates a combination of both</span><br><br>All information is indicative<br>You should not solely rely on ReleaseMgr for evaluating the impact of updating your current firmware/software.',
                            guideDark: '<strong>All release notes should be read in full before updating!<br/>You are fully responsible for the consequences of updating your firmware.<br></strong>Superceded Beta and RC firmware versions are not generally supported, and using them is at your own risk.',
